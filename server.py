...
def disease_information(predicted_class):
    diseases = {
        0: {
            ...
            'chemical_treatment': 'Fungicides containing chlorothalonil, mancozeb, or copper-based compounds can be effective.',
            'specific_chemical_treatments': 'Daconil (chlorothalonil), Mancozeb, Copper fungicides (e.g., Bordeaux mixture).'
        },
        1: {
            'name': 'Anthracnose',
        ...
        3: {
            ...
            'chemical_treatment': 'Fungicides with fenhexamid, iprodione, or chlorothalonil can be effective.',
            'specific_chemical_treatments': 'Elevate (fenhexamid): Specifically targets Botrytis and provides protective and curative action. Chipco 26019 (iprodione): A fungicide effective against Botrytis and other fungal diseases. Daconil (chlorothalonil): Provides broad-spectrum control against many fungal pathogens.'
        },
        4: {
            'name': 'Chlorosis',
            ...
            'chemical_treatment': 'Fertilizers containing the deficient nutrient can correct the specific deficiency causing chlorosis.',
            'specific_chemical_treatments': 'Iron chelates (e.g., Iron EDTA): For correcting iron deficiency, which is a common cause of chlorosis. Manganese sulfate: Used to correct manganese deficiency, another cause of chlorosis. Nitrogen-rich fertilizers: For correcting nitrogen deficiency, which can lead to overall yellowing of leaves.'
        },
        5: {
            'name': 'Curl Leaf',
            ...
            'chemical_treatment': 'Pesticides, fungicides, and appropriate fertilization can help manage the underlying causes of curl leaf.',
            'specific_chemical_treatments': 'Insecticidal soap or neem oil: For controlling soft-bodied pests like aphids and mites. Fungicides: For managing fungal infections that cause leaf curl. Balanced fertilizers: To address nutrient imbalances that can lead to leaf curling.'
        },
        6: {
            'name': 'Die black',
            'description': 'This is not a disease,This is just a dead leaf.',
        },
        7: {
            'name': 'Downy Mildew',
            ...
            'chemical_treatment': 'Fungicides with metalaxyl, fosetyl-Al, or copper-based compounds can be effective.',
            'specific_chemical_treatments': 'Ridomil Gold (metalaxyl): Provides systemic control of downy mildew and other oomycete pathogens. Aliette (fosetyl-Al): A systemic fungicide effective against downy mildew. Copper fungicides (e.g., Copper Oxychloride): Effective against downy mildew when applied preventatively.'
        },
        8 :{
            'name': 'Healthy',
            'Description': 'This is not a disease,This is just a Healthy plant leaf.'
        },
        ...
        9:{
            ...
            'chemical_treatment': 'Fungicides containing chlorothalonil, mancozeb, or copper-based compounds can be effective against fungal blight.Bactericides may be needed if bacterial blight is present.',
            'specific_chemical_treatments': ' Daconil (chlorothalonil): Provides broad-spectrum control against many fungal pathogens.Mancozeb: Effective against a wide range of fungal diseases.Copper fungicides (e.g., Bordeaux mixture): Effective against many fungal and bacterial diseases.Streptomycin: An antibiotic effective against bacterial blight.'
        },
        13: {
            'name': 'Powdery Mildew',
            ...
            'chemical_treatment': 'Fungicides with sulfur, potassium bicarbonate, or myclobutanil can be effective.',
            'specific_chemical_treatments': 'Sulfur: Provides effective control of powdery mildew when applied preventatively. Kaligreen (potassium bicarbonate): A contact fungicide that disrupts fungal cell walls. Rally (myclobutanil): A systemic fungicide that provides curative and protective action against powdery mildew.'
        },
        14: {
            'name': 'Rust',
            ...
            'chemical_treatment': 'Fungicides with myclobutanil, azoxystrobin, or sulfur can be effective.',
            'specific_chemical_treatments': 'Rally (myclobutanil): A systemic fungicide that provides curative and protective action against rust. Heritage (azoxystrobin): A broad-spectrum fungicide that controls rust and other fungal diseases. Sulfur: Provides effective control of rust when applied preventatively.'
        },
        10:{
            'name': 'Leaf Necrosis',
            ...
            'Conditions of Infection' : 'Fungal or bacterial infections can cause necrotic spots or patches on leaves. Chemical damage from herbicides, pesticides, or fertilizers can lead to necrosis.Environmental stress, such as drought, extreme temperatures, or nutrient imbalances, can cause leaf tissue to die.',
            'mechanical_treatment' : 'Remove and destroy affected leaves to reduce sources of inoculum.Improve air circulation around plants by proper spacing and pruning.Avoid overhead watering and water early in the day to allow foliage to dry before nightfall',
            'chemical_treatment' : 'Fungicides containing chlorothalonil, mancozeb, or copper-based.compounds can be effective against fungal blight.Bactericides may be needed if bacterial blight is present.',
            'specific chemincal' : 'Daconil (chlorothalonil): Provides broad-spectrum control against many fungal pathogens.Mancozeb: Effective against a wide range of fungal diseases.Copper fungicides(e.g., Bordeaux mixture): Effective against many fungal and bacterial diseases.Streptomycin: An antibiotic effective against bacterial blight.'
        },
        11:{
             'name': 'Leaf Spot',
       ...
       16:{
           'name': 'Sooty mold',
            ...
            'Conditions of Infection' : ' Sooty mold is a fungal disease that forms a black coating on plant\'s leaves and stems, blocking sunlight and reducing photosynthesis. It can also diminish a plant\'s aesthetic value.',
            ...
            'chemical_treatment' : 'Chemical treatment for sooty mold involves washing off mold with a hosepipe, controlling insect vectors with contact insecticides, and preventing infestations by regularly cleaning foliage and managing pests.',
            'specific chemincal' : 'Horticultural Oil: This can be effective in suffocating the mold by coating the surface where the mold is growing.Neem Oil: Known for its antifungal properties, neem oil can help control sooty mold when applied to affected plants.Copper Fungicides: These are effective against a wide range of fungal diseases, including sooty mold. However, they should be used cautiously as they can be harsh on some plants.Sulfur-Based Fungicides: These can also be used to control sooty mold, but like copper fungicides, they should be used carefully to avoid damage to sensitive plants.Systemic Fungicides: These are absorbed by the plant and can provide longer-term control of sooty mold. They are typically used when the mold is persistent and widespread.'
       },
       17:{
            'name': 'Sooty Mould',
            ...
            'chemical_treatment' : 'Insecticidal Soaps: Effective in controlling sap-sucking insects that produce honeydew. Apply according to label instructions, ensuring thorough coverage of the plant.Horticultural Oils: These oils can suffocate insects and reduce honeydew production. Apply during cooler parts of the day to avoid leaf burn.Systemic Insecticides: These are absorbed by the plant and can provide longer-lasting protection against sap-sucking insects. Follow label directions for proper use.',
            'specific chemincal' : 'Neem Oil:A natural oil that can control a wide range of sap-sucking insects.Apply every 7-14 days, depending on the severity of the infestation.Imidacloprid:A systemic insecticide that is effective against sap-sucking insects.Apply as a soil drench or foliar spray according to label instructions.Pyrethrin-Based Insecticides:Effective for quick knockdown of insects like aphids and whiteflies.Use as a contact spray and reapply as needed based on label instructions.Horticultural Oil (Petroleum-based or Plant-based):Controls insects by suffocation and can reduce sooty mould by eliminating honeydew production.Apply during dormant season for best results, and follow label directions carefully to avoid plant damage.'
       }
